...
public class EntityServiceImplTest  {
    ...
    public void testfindByItemId() throws Exception {
        ...
        // The returned Entity should match the mocked state of our reference item
    ...
    public void testGetLeftRelation() {
        ...
        // The left relation(s) reported from our mocked Entity should equal our relationshipList
    ...
    public void testGetRightRelation() {
        ...
        // The right relation(s) reported from our mocked Entity should equal our relationshipList
    ...
    public void testGetRelationsByLabel() throws Exception {
        ...
        // Mock the state of objects utilized in getRelationsByLabel() to meet the success criteria of the invocation
        ...
        // The relation(s) reported from our defined label should equal our relationshipList
    ...
    public void testGetAllRelationshipTypes() throws Exception {
        //Decalre objects utilized for this test
        List<MetadataValue> list = new ArrayList<>();
        MetadataValue metadataValue = mock(MetadataValue.class);
        list.add(metadataValue);
        Item item = mock(Item.class);
        ...
        // The relation(s) reported from our mocked Entity should equal our relationshipList
    ...
    public void testGetLeftRelationshipTypes() throws Exception {
        ...
        // The left relationshipType(s) reported from our mocked Entity should equal our relationshipList
    ...
    public void testGetRightRelationshipTypes() throws Exception {
        ...
        // The right relationshipType(s) reported from our mocked Entity should equal our relationshipList
    ...
    public void testGetRelationshipTypesByLabel() throws Exception {
        ...
        // The RelationshipType(s) reported from our mocked Entity should equal our list
